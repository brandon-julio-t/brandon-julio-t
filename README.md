...
- 🌍 Contribute upstream fixes to tools I use, including Effect, Convex, PostHog, Pitchfork, Opencode, ghui, Motion Primitives, React docs, and Vague.
...
| [jdx/pitchfork#580](https://github.com/jdx/pitchfork/pull/580) | Restored ARM64 Linux GNU release compatibility for Amazon Linux 2023 by pinning the `aarch64-unknown-linux-gnu` cross image after a mutable image picked up a newer `GLIBC_2.39` requirement. | ✅ Merged |
...
| 🛠️ Open-source ecosystem | Practical upstream fixes across Effect, PostHog, Opencode, Convex, and Motion Primitives. |
